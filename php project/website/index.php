<?php
    ...
    $logo = mysqli_query($dbconnect, $logo_select);
    $value= mysqli_fetch_assoc($logo);

$select_slide = "SELECT * FROM slider WHERE status=1";
        ...
        <nav class="megamenu navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="../admin/image/logo/<?php echo $value['logo'];?>" alt="image" width="150" height="50"></a>
                </div>
					...
					<div class="row">
						<div class="slider-content-area">
							<div class="slide-text">
								<h1 class="homepage-three-title"></h1>
